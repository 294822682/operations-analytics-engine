...
def test_markdown_content_uses_concise_daily_dialog_format() -> None:
    ...
    expected = (
        ...
        "待交车（累计）：3\n"
        "来客线索数（手机号去重）\n"
        "累计来客线索数（账号）：星途汽车官方直播间(15)、星途汽车直播营销中心(4)\n"
        "累计来客线索数（主播）：丁俐佳(4)、孙慧敏(4)、何雯(5)、徐幻(2)、侯翩翩(2)、徐欣悦(2)"
    )
...
def _report_context() -> ReportContext:
    ...
    account_table = pd.DataFrame(
        [
            {"账号": "星途汽车官方直播间", "抖音-来客线索数（手机号去重）": "15"},
            {"账号": "星途汽车直播营销中心", "抖音-来客线索数（手机号去重）": "4"},
            {"账号": "星途汽车直营中心", "抖音-来客线索数（手机号去重）": "0"},
            {"账号": "线索组汇总", "抖音-来客线索数（手机号去重）": "19"},
        ]
    )
    anchor_table = pd.DataFrame(
        [
            {"主播": "丁俐佳", "归属账号": "星途汽车官方直播间", "抖音-来客线索数（手机号去重）": "4"},
            {"主播": "孙慧敏", "归属账号": "星途汽车官方直播间", "抖音-来客线索数（手机号去重）": "4"},
            {"主播": "何雯", "归属账号": "星途汽车官方直播间", "抖音-来客线索数（手机号去重）": "5"},
            {"主播": "徐幻", "归属账号": "星途汽车官方直播间", "抖音-来客线索数（手机号去重）": "2"},
            {"主播": "侯翩翩", "归属账号": "星途汽车直播营销中心", "抖音-来客线索数（手机号去重）": "2"},
            {"主播": "徐欣悦", "归属账号": "星途汽车直播营销中心", "抖音-来客线索数（手机号去重）": "2"},
        ]
    )
